...
exports.isArrayStrings = (val) =>
  exports.isArrayFull(val) && val.every((v) => exports.isStringFull(v));
exports.isObject = (val) => typeof val === 'object' && !exports.isNull(val);
exports.isObjectFull = (val) =>
  exports.isObject(val) && exports.hasLength(obj_util_1.objKeys(val));
...
exports.isDateString = (val) =>
  exports.isStringFull(val) &&
  !exports.isNumeric(val) &&
  exports.isNumber(+new Date(val));
...
exports.hasValue = (val) =>
  exports.isArrayFull(val) ? val.every((o) => exports.isValue(o)) : exports.isValue(val);
