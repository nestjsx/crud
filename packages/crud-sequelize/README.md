...
- [**@nestjsx/crud-sequelize**](https://www.npmjs.com/package/@nestjsx/crud-sequelize) - Sequelize package which provides base `SequelizeCrudService` with methods for CRUD database operations
