...
export class Swagger {
  ...
  static getOperation(func: Function): any {
    ...
    return swaggerPkg
      ? R.get(swaggerPkg.DECORATORS.API_OPERATION, func) || {}
      : {};
  }
  ...
  static getParams(func: Function): any[] {
    /* istanbul ignore next */
    return swaggerPkg
      ? R.get(swaggerPkg.DECORATORS.API_PARAMETERS, func) || []
      : [];
  }
  ...
  static getResponseOk(func: Function): any {
    /* istanbul ignore next */
    return swaggerPkg
      ? R.get(swaggerPkg.DECORATORS.API_RESPONSE, func) || {}
      : {};
  }

  static createReponseOkMeta(
    status: HttpStatus,
    isArray: boolean,
    dto: any
  ): any {
