...
class Swagger {
  ...
  static setOperation(name, modelName, func) {
    if (exports.swaggerPkg) {
      ...
      reflection_helper_1.R.set(
        exports.swaggerPkg.DECORATORS.API_OPERATION,
        { summary },
        func,
      );
    }
  ...
  static setParams(metadata, func) {
    if (exports.swaggerPkg) {
      reflection_helper_1.R.set(
        exports.swaggerPkg.DECORATORS.API_PARAMETERS,
        metadata,
        func,
      );
    }
  ...
  static setResponseOk(metadata, func) {
    if (exports.swaggerPkg) {
      reflection_helper_1.R.set(
        exports.swaggerPkg.DECORATORS.API_RESPONSE,
        metadata,
        func,
      );
    }
  ...
  static getOperation(func) {
    return exports.swaggerPkg
      ? reflection_helper_1.R.get(exports.swaggerPkg.DECORATORS.API_OPERATION, func) || {}
      : {};
  }
  static getParams(func) {
    return exports.swaggerPkg
      ? reflection_helper_1.R.get(exports.swaggerPkg.DECORATORS.API_PARAMETERS, func) ||
          []
      : [];
  }
  static getResponseOk(func) {
    return exports.swaggerPkg
      ? reflection_helper_1.R.get(exports.swaggerPkg.DECORATORS.API_RESPONSE, func) || {}
      : {};
  }
